...
public sealed class Money
{
    ...
    {
        money = Guard.Against.Null(money, nameof(money));
        Yuan1 = Guard.Against.Negative(Yuan1 - money.Yuan1, nameof(money.Yuan1));
        Yuan2 = Guard.Against.Negative(Yuan2 - money.Yuan2, nameof(money.Yuan2));
        Yuan5 = Guard.Against.Negative(Yuan5 - money.Yuan5, nameof(money.Yuan5));
        Yuan10 = Guard.Against.Negative(Yuan10 - money.Yuan10, nameof(money.Yuan10));
        Yuan20 = Guard.Against.Negative(Yuan20 - money.Yuan20, nameof(money.Yuan20));
