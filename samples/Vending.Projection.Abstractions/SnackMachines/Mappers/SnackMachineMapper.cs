...
{
    /// <summary>
    ///     Converts a <see cref="Domain.Abstractions.SnackMachines.SnackMachine" /> to a <see cref="SnackMachine" />.
    /// </summary>
    /// <param name="machineInGrain">The <see cref="Domain.Abstractions.SnackMachines.SnackMachine" /> to convert.</param>
    ...
    /// <returns>The <see cref="SnackMachine" /> converted from the <see cref="Domain.Abstractions.SnackMachines.SnackMachine" />.</returns>
    public static async Task<SnackMachine> ToProjection(this Domain.Abstractions.SnackMachines.SnackMachine machineInGrain, Func<Guid, Task<(string, string?)>> getSnackNamePicture, SnackMachine? machine = null)
    {
