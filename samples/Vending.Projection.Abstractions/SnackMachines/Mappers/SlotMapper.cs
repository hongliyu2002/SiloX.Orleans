...
{
    /// <summary>
    ///     Maps a <see cref="Domain.Abstractions.SnackMachines.Slot" /> to a <see cref="Slot" />.
    /// </summary>
    /// <param name="slotInGrain">The <see cref="Domain.Abstractions.SnackMachines.Slot" /> to map. </param>
    ...
    public static async Task<Slot> ToProjection(this Domain.Abstractions.SnackMachines.Slot slotInGrain, Func<Guid, Task<(string, string?)>> getSnackNamePicture, Slot? slot = null)
    {
        slot ??= new Slot();
