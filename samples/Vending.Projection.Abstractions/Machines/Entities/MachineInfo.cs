...
{
    /// <summary>
    ///     The ID of the snack machine.
    /// </summary>
    [Id(0)]
    public Guid Id { get; set; }

    /// <summary>
    ///     The version of the snack machine.(Concurrency token)
    /// </summary>
    [Id(1)]
    public int Version { get; set; }

    /// <summary>
    ///     The amount of money currently inside the snack machine.
    /// </summary>
    [Id(2)]
    ...
    /// <summary>
    ///     The list of slots in the snack machine.
    /// </summary>
    [Id(4)]
    ...
    /// <summary>
    ///     The name of the user who created the snack machine.
    /// </summary>
    [Id(6)]
    ...
    /// <summary>
    ///     The name of the user who last modified the snack machine.
    /// </summary>
    [Id(8)]
    ...
    /// <summary>
    ///     The name of the user who deleted the snack machine.
    /// </summary>
    [Id(10)]
    ...
    /// <summary>
    ///     The number of distinct snacks in the snack machine.
    /// </summary>
    [Id(13)]
    public int SnackCount { get; set; }

    /// <summary>
    ///     The total quantity of snacks in the snack machine.
    /// </summary>
    [Id(14)]
    public int SnackQuantity { get; set; }

    /// <summary>
    ///     The total amount of money from snacks in the snack machine.
    /// </summary>
    [Id(15)]
    public decimal SnackAmount { get; set; }

    /// <summary>
    ///     The number of times snacks have been bought from the snack machine.
    /// </summary>
    [Id(16)]
    public int BoughtCount { get; set; }

    /// <summary>
    ///     The total amount of money spent on snacks from the snack machine.
    /// </summary>
    [Id(17)]
