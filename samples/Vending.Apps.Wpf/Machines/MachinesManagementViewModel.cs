...
public class MachinesManagementViewModel : ReactiveObject, IActivatableViewModel
{
    ...
    public MachinesManagementViewModel()
    {
        ...
        var machinesObs = machinesCache.Connect()
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan1)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan2)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan5)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan10)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan20)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan50)
                                       .AutoRefresh(machine => machine.MoneyInside.Yuan100)
                                       .AutoRefresh(machine => machine.MoneyInside.Amount)
                                       .AutoRefresh(machine => machine.AmountInTransaction)
                                       .AutoRefresh(machine => machine.SlotCount)
                                       .AutoRefresh(machine => machine.SnackCount)
                                       .AutoRefresh(machine => machine.SnackQuantity)
                                       .AutoRefresh(machine => machine.SnackAmount)
                                       .AutoRefresh(machine => machine.BoughtCount)
                                       .AutoRefresh(machine => machine.BoughtAmount)
                                       .AutoRefresh(machine => machine.IsDeleted)
