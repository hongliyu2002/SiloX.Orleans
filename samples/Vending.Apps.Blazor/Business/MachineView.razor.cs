...
public partial class MachineView : ReactiveComponentBase<MachineViewModel>
{
    ...
    public Guid Id
    {
        ...
        set
        {
            ...
            Deactivate();
            ViewModel = value != Guid.Empty ? new MachineViewModel(value) : null;
            Activate();
        }
    }
