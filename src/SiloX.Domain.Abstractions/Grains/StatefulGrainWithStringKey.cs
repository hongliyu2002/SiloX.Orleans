...
public abstract class StatefulGrainWithStringKey<TState, TPubEvent, TPubErrorEvent> : Grain<TState>, IGrainWithStringKey
    ...
    where TPubErrorEvent : TPubEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="StatefulGrainWithStringKey{TState, TPubEvent, TPubErrorEvent}" /> class.
    /// </summary>
    /// <param name="streamProviderName">The name of the stream provider.</param>
    protected StatefulGrainWithStringKey(string streamProviderName)
    {
