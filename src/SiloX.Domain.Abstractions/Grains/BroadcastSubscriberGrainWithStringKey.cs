...
/// </summary>
public abstract class BroadcastSubscriberGrainWithStringKey<TEvent, TErrorEvent> : Grain, IGrainWithStringKey
    ...
    where TErrorEvent : TEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="BroadcastSubscriberGrainWithStringKey{TEvent,TErrorEvent}" /> class with
    ...
    protected BroadcastSubscriberGrainWithStringKey(string streamProviderName)
    {
