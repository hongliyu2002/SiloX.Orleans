...
public abstract class StatefulGrainWithGuidKey<TState, TEvent, TErrorEvent> : Grain<TState>, IGrainWithGuidKey
    ...
    where TErrorEvent : TEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="StatefulGrainWithGuidKey{TState, TEvent, TErrorEvent}" /> class.
    /// </summary>
