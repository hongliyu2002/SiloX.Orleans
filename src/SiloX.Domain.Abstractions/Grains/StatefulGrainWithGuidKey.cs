...
public abstract class StatefulGrainWithGuidKey<TState, TPubEvent, TPubErrorEvent> : Grain<TState>, IGrainWithGuidKey
    ...
    where TPubErrorEvent : TPubEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="StatefulGrainWithGuidKey{TState, TPubEvent, TPubErrorEvent}" /> class.
    /// </summary>
    /// <param name="streamProviderName">The name of the stream provider.</param>
    protected StatefulGrainWithGuidKey(string streamProviderName)
    {
