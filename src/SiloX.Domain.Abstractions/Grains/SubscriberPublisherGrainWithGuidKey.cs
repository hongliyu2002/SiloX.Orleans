...
/// </summary>
public abstract class SubscriberPublisherGrainWithGuidKey<TSubEvent, TSubErrorEvent, TPubEvent, TPubErrorEvent> : Grain, IGrainWithGuidKey
    ...
    where TPubErrorEvent : TPubEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SubscriberPublisherGrainWithGuidKey{TSubEvent, TSubErrorEvent, TPubEvent, TPubErrorEvent}" /> class with
    ...
    protected SubscriberPublisherGrainWithGuidKey(string streamProviderName)
    {
    ...
    protected SubscriberPublisherGrainWithGuidKey(string subStreamProviderName, string pubStreamProviderName)
    {
