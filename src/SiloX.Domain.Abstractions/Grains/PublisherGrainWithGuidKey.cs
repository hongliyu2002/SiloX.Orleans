...
/// </summary>
public abstract class PublisherGrainWithGuidKey<TPubEvent, TPubErrorEvent> : Grain, IGrainWithGuidKey
    ...
    where TPubErrorEvent : TPubEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="PublisherGrainWithGuidKey{TPubEvent, TPubErrorEvent}" /> class with
    ...
    protected PublisherGrainWithGuidKey(string streamProviderName)
    {
