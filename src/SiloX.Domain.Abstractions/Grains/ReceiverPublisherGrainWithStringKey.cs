...
/// </summary>
public abstract class ReceiverPublisherGrainWithStringKey<TSubEvent, TSubErrorEvent, TPubEvent, TPubErrorEvent> : Grain, IGrainWithStringKey
    ...
    where TPubErrorEvent : TPubEvent, IDomainErrorEvent
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="ReceiverPublisherGrainWithStringKey{TSubEvent, TSubErrorEvent, TPubEvent, TPubErrorEvent}" /> class with
    ...
    protected ReceiverPublisherGrainWithStringKey(string streamProviderName)
    {
    ...
    protected ReceiverPublisherGrainWithStringKey(string subStreamProviderName, string pubStreamProviderName)
    {
