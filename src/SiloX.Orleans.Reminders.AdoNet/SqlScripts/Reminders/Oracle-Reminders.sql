...
CREATE OR
REPLACE FUNCTION UpsertReminderRow(PARAM_SERVICEID IN NVARCHAR2, PARAM_GRAINHASH IN INT, PARAM_GRAINID IN VARCHAR2, PARAM_REMINDERNAME IN NVARCHAR2,
...
BEGIN
    ...
    USING (SELECT PARAM_SERVICEID    as SERVICEID,
    ...
    WHEN MATCHED THEN
        UPDATE
        SET ort.StartTime = n_ort.STARTTIME,
...
CREATE OR
REPLACE FUNCTION DeleteReminderRow(PARAM_SERVICEID IN NVARCHAR2, PARAM_GRAINID IN VARCHAR2, PARAM_REMINDERNAME IN NVARCHAR2,
